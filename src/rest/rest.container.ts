...
import { Config, RestConfig, RestShema } from '../shared/libs/config/index.js';
...
export function createRestApplicationContainer() {
  ...
  restApplicationContainer.bind<Config<RestShema>>(Component.Config).to(RestConfig).inSingletonScope();
